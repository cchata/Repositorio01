...
//	               new DefaultStreamedContent(inputStream, mimeType, fileName);
...
//            streamedContent = new DefaultStreamedContent(in, "application/pdf");
	    ...
	    public static StreamedContent getStreamContentFromOutputStream(ByteArrayOutputStream os, String contentType) throws Exception {
	        StreamedContent file = null;
	        InputStream is = new ByteArrayInputStream(os.toByteArray());
