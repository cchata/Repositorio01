package com.ecoinnova.pe.dao.util;
...
public class GenericEntityDaoImpl<T, ID extends Serializable> implements GenericEntityDao<T, Serializable> {
    ...
    public List listCriterion(List<Criterion> listCriterion) {
        Criteria criteria = getSessionFactory().getCurrentSession().createCriteria(oClass);
