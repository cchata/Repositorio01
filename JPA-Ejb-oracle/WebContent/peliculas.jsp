<html lang="es">
	...
	<script type="text/javascript" src="js/peliculaJS.js" ></script>
		...
		<section id="main">
			...
			<section id="content">
				...
				<article>
						...
						<% if(accion==NUEVO){ %>
							  <%@include file="jsp/crudPelicula/nuevoPelicula.jsp" %>
						<% }else if(accion==BUSCAR){ %>
							  <%@include file="jsp/crudPelicula/buscarPelicula.jsp" %>
						<% }else if(accion==ELIMINAR){ %>
						      <%@include file="jsp/crudPelicula/eliminarPelicula.jsp" %>
						<% }else if(accion==ACTUALIZAR){ %>
						      <%@include file="jsp/crudPelicula/actualizarPelicula.jsp" %>
						<% }else if(accion==LISTAR){ %>
						      <%@include file="jsp/crudPelicula/listadoPelicula.jsp" %>
						<% }else if(accion==CRUD){ %>
			                  <%@include file="jsp/crudPelicula/crudPelicula.jsp" %>
			            <% }else{ %>
			...
			<aside id="sidebar">
				...
				<h3>Things To Do</h3>
				<ul>
					<li><a href="insertarPSvr.html">Nuevo pelicula</a></li>
					<li><a href="listarPSvr.html">Listado pelicula</a></li>
					<li><a href="buscarPSvr.html">Buscar pelicula</a></li>
					<li><a href="eliminarPSvr.html">Eliminar pelicula</a></li>
					<li><a href="actualizarPSvr.html">Actualizar pelicula</a></li>
					<li><a href="crudPelucilaSvr.html">Crud Pelicula</a></li>
				</ul>
