CREATE OR REPLACE PROCEDURE USUCCHATA.pa_ficha_matric_generar_codigo(p_codigo_generado out varchar2) IS
...
begin 
   ...
   SELECT MAX(NUMEROFICHA_PK) INTO v_codigo FROM FICHA_MATRICULA;
...
if v_valor<1000000 then
   ...
   begin
       dbms_output.put_line('Codigo de FICHA_MATRICULA desbordado.');
   end; 
end if;     
