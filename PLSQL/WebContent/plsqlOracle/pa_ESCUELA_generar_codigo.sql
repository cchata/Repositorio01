CREATE OR REPLACE PROCEDURE USUCCHATA.pa_ESCUELA_generar_codigo(p_codigo_generado out varchar2) IS
...
begin 
   ...
   SELECT MAX(CODIGOESCUELA_PK) INTO v_codigo FROM ESCUELA;
...
if v_valor<1000000 then
   ...
   begin
       dbms_output.put_line('Codigo de ESCUELA desbordado.');
   end; 
end if;     
