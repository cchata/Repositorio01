  ...
  public void RegistrarEmpleado()
  {
        ...
        if(vCodigo.isEmpty() || vCodigoCar.isEmpty() || vDNI.isEmpty() || vNombre.isEmpty() || vApellidos.isEmpty() || this.txtFechaNacimiento.getDate()==null || vDireccion.isEmpty() || vTelefono.isEmpty() || vCelular.isEmpty()){
            ...
            if(this.txtDNI.getText().length() < 8){
                ...
                JOptionPane.showMessageDialog(this,"El campo TELÉFONO debe tener como mínimo 7 dígitos");
                ...
                if(respuesta==JOptionPane.OK_OPTION)
                {
                    ...
                    try {
                        ...
                        if(empleado.empleado_registrar(objEmpleado)==true){
                            this.ListarEmpleado();
                            JOptionPane.showMessageDialog(this,"Regístro guardado con éxito");
                        }else{
                ...
                if(respuesta==JOptionPane.OK_OPTION)
                {
                    ...
                    try {
                        ...
                        if(empleado.empleado_editar(objEmpleado)==true){
                            this.ListarEmpleado();
                            JOptionPane.showMessageDialog(this,"Regístro actualizado con éxito");
                        }else{
        ...
        if(respuesta==JOptionPane.OK_OPTION)
        {
            try
            {
                ...
                if(empleado.empleado_eliminar(codigo)==true){
                    this.ListarEmpleado();
                    JOptionPane.showMessageDialog(this,"Regístro eliminado con éxito");
                }else{
  ...
  public void ObtenerCargo(String codigo)
  {
    ...
    public void ListarEmpleado(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error de Código :"+ne.toString());
